...
#                ('date', 'emisdate', 'Date of Attendance Record', True),
    ...
    'latrines':[
            ('g', 'int', 'Number of Latrines for Girls', False),
            ('b', 'int', 'Number of Latrines for Boys', False),
            ('f', 'int', 'Number of Latries for Female Teachers', False),
            ('m', 'int', 'Number of Latries for Female Teachers', False),
            ('s', 'int', 'Number of shared latrines by Everybody', False),
            ('sp', 'int', 'Number of shared latrines by Pupils', False),
            ('st', 'int', 'Number of shared latrines by Teachers', False),
     ],
    'latrinesused':[
            ('g', 'int', 'Number of Latrines for Girls', True),
            ('b', 'int', 'Number of Latrines for Boys', True),
            ('f', 'int', 'Number of Latries for Female Teachers', True),
            ('m', 'int', 'Number of Latries for Male Teachers', True),
            ('s', 'int', 'Number of shared latrines used by Everybody', False),
            ('sp', 'int', 'Number of shared latrines used by Pupils', False),
            ('st', 'int', 'Number of shared latrines used by Teachers', False),
     ],
    'deploy':[
            ('f', 'int', 'Number of Female Teachers Deployed', True),
            ('m', 'int', 'Number of Male Teachers Deployed', True),
